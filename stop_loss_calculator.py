def main():
    ...
    round_float_entry_price = round(float_entry_price,2)
    ...
    float_percentage_round = round(float_percentage,2)
    ...
    final_value_round = round(final_value,2)
    ...
    take_profit_round = round(take_profit,2)
